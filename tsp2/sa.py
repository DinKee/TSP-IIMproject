...
def sa():
    ...
    T_0, T, T_MIN = args.init_temperature, args.init_temperature, 1#初始溫度,當前,結束
    T_NUM_CYCLE = 1
    ...
    export2json(initial, sol_best)
    #export2js(initial,"path")
    # Plot cost function and TSP-route
    plot(sol_best.tolist(), coordinates, costs,unchange_coordinates,t0)
